	    ...
	    break
         ...
         break
	       case 'smeme': case 'stickmeme': case 'stikmeme': case 'stickermeme': case 'stikermeme': {
	        ...
	        let FaTiH = await xavior.sendImageAsSticker(m.chat, smeme, m, { packname: global.packname, author: global.author })
...
⭔ *Url* : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
                anug = await pinterest(text)
                resultan = anug[Math.floor(Math.random() * anug.length)]
                xavior.sendMessage(m.chat, { image: { url: resultan }, caption: `⭔${text} ` }, { quoted: m })
            }
            break
...
└───────⭓`
		...
		if (isCmd && budy.toLowerCase() != undefined) {
            ...
            m.reply(m.chat, msgs[budy.toLowerCase()], true)
